...
#define GPIO_TFLASH_EN	176	/* TFLASH_EN GPIO */
...
#define PMIC_GPIO_PS_VOUT				29
#define TAOS_INT PM8058_GPIO_IRQ(PMIC8058_IRQ_BASE, PMIC_GPIO_PS_VOUT)
#endif
#if defined(CONFIG_SENSORS_YAS_ACCEL_DRIVER) || defined(CONFIG_SENSORS_YAS530C)
#define SENSORS_GPIO_SDA_REV_3			1
#define SENSORS_GPIO_SCL_REV_3			0
#define SENSORS_GPIO_SDA_REV_4			80
#define SENSORS_GPIO_SCL_REV_4			84
#define PMIC_GPIO_MSENSE_RST			34
#endif
...
unsigned long ebi0_size = 0X20000000;
...
static const unsigned int ray_keymap[] = {
...
static struct matrix_keymap_data ray_keymap_data = {
	.keymap_size	= ARRAY_SIZE(ray_keymap),
	.keymap		= ray_keymap,
};

static struct pm8xxx_keypad_platform_data ray_keypad_data = {
	.input_name		= "ray-keypad",
	.input_phys_device	= "ray-keypad/input0",
	.num_rows		= 5,
	.num_cols		= 5,
...
static struct pmic8058_led pmic8058_ray_leds[] = {
	[0] = {
...
static struct pmic8058_leds_platform_data pm8058_ray_leds_data = {
	.num_leds = ARRAY_SIZE(pmic8058_ray_leds),
	.leds	= pmic8058_ray_leds,
};
...
static struct i2c_gpio_platform_data camera_i2c_gpio_data = {
	.sda_pin = GPIO_I2C_DATA_CAM,
	.scl_pin = GPIO_I2C_CLK_CAM,
...
static struct msm_camera_sensor_platform_info sensor_board_info_isx012 = {
	...
	.flash_set	= GPIO_MSM_FLASH_CNTL_SET,
...
static struct i2c_gpio_platform_data front_camera_i2c_gpio_data = {
	.sda_pin = 174,
	.scl_pin = 177,
	.udelay = 2,		/* i2c speed : 500 / 2 = 250k */
};

static struct platform_device front_camera_i2c_gpio_device = {
	.name = "i2c-gpio",
	.id = 20,
	.dev = {
		.platform_data = &front_camera_i2c_gpio_data,
		},
};
...
static struct msm_camera_csi_lane_params sr130pc10_csi_lane_params = {
	.csi_lane_assign = 0xE4,
	.csi_lane_mask = 0x3,
};

static struct msm_camera_sensor_platform_info sensor_board_info_sr130pc10 = {
	.mount_angle	= 270,
	.cam_vreg = msm_7x30_back_cam_vreg,
	.num_vreg = ARRAY_SIZE(msm_7x30_back_cam_vreg),
	.gpio_conf = &msm_7x30_back_cam_gpio_conf,
	.csi_lane_params = &sr130pc10_csi_lane_params,
	.sensor_reset	= GPIO_CAM1_RST_N,
	.sensor_stby	= GPIO_MAIN_STBY,
	.vt_sensor_stby	= GPIO_VT_STBY,
	.vt_sensor_reset	= GPIO_CAM2_RST_N,
...
static struct msm_camera_sensor_info msm_camera_sensor_sr130pc10_data = {
	...
	.sensor_platform_info = &sensor_board_info_sr130pc10,
	.csi_if	= 0, /*parallel*/
			...
			struct device_attribute *attr, char *buf)
{
	...
	char cam_type[] = "SILICON_SR130PC10\n";
#else
...
static unsigned char gVendorID = 0;
static ssize_t back_camera_vendorID_show(struct device *dev,
			struct device_attribute *attr, char *buf)
{
#if defined(CONFIG_ISX012)
	if (0 == gVendorID) {
		rear_sensor_check_vendorID_before(&gVendorID);
		rear_sensor_check_vendorID_done();
	}
#endif
	/*For samsung camera module, show 0x1xx, xx is vendor id */
	return sprintf(buf, "0x1%02x\n", gVendorID);
}
			...
			const char *buf, size_t size)
{
	...
	if (strnlen(buf, 1) > 2) {
		printk(KERN_ERR "%s, strnlen() failed.", __func__);
		return -err;
	}
	...
	if (isdigit(*buf)) {
		...
		printk(KERN_ERR "%s, isdigit() failed.", __func__);
		return -err;
	}

	/*if (flash_rev) {
		gpio_set_value_cansleep(GPIO_MSM_FLASH_CNTL_SET, value ? 1 : 0);
	}*/

	if (value == 0) {
		printk(KERN_ERR "[Torch flash]OFF\n");
		gpio_set_value_cansleep(gpio_flash_en, 0);
		gpio_set_value_cansleep(gpio_flash_set, 0);
		torchonoff = 0;

	} else {
		printk(KERN_ERR "[Torch flash]ON\n");
		gpio_set_value_cansleep(gpio_flash_en, 0);
...
void msm7x30_cam_create_node(void)
{
...
OUT0:
	printk(KERN_ERR "[CAMERA_DEV]OUT0\n");
...
#endif	/* defined(CONFIG_ISX012) || defined(CONFIG_SR130PC10) */

void __init msm7x30_init_cam(void)
{
#ifdef CONFIG_MACH_RAY
#if defined(CONFIG_ISX012) || defined(CONFIG_SR130PC10)
	msm7x30_cam_create_node();
#endif	/* defined(CONFIG_ISX012) || defined(CONFIG_SR130PC10) */
	...
	s_info->sensor_platform_info->flash_set =
		GPIO_MSM_FLASH_CNTL_SET;

	gpio_flash_en = s_info->sensor_platform_info->flash_en;
	gpio_flash_set = s_info->sensor_platform_info->flash_set;
#endif	/*CONFIG_ISX012*/
#endif	/*CONFIG_MACH_RAY*/
#ifdef CONFIG_ISX012
	platform_device_register(&camera_i2c_gpio_device);
#endif
#ifdef CONFIG_SR130PC10
	platform_device_register(&front_camera_i2c_gpio_device);
#endif
...
#endif
#ifdef CONFIG_SR130PC10
static struct i2c_board_info msm_front_camera_boardinfo[] = {
	{
...
/* Target : out_freq = 26 KHz, 50% duty-cycle */
	...
	.vib_pwm_N = 4733, /* N value of M/N:D counter */
	.vib_pwm_D = 4733>>1, /* D value of M/N:D counter */
};
...
void msm_snddev_sub_tx_route_config(void)
{
	pr_info("%s micbias on\n", __func__);
	gpio_tlmm_config(GPIO_CFG
			 (MSM_GPIO_SUBMICBIAS_EN, 0, GPIO_CFG_OUTPUT,
			  GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_set_value_cansleep(MSM_GPIO_SUBMICBIAS_EN, 1);

	return;
}

void msm_snddev_sub_tx_route_deconfig(void)
{
	pr_info("%s micbias off\n", __func__);
	gpio_set_value_cansleep(MSM_GPIO_SUBMICBIAS_EN, 0);

	return;
}

void msm_snddev_dual_tx_route_config(void)
{
	pr_info("%s micbias on\n", __func__);
	gpio_tlmm_config(GPIO_CFG
			 (MSM_GPIO_SUBMICBIAS_EN, 0, GPIO_CFG_OUTPUT,
...
void msm_snddev_dual_tx_route_deconfig(void)
{
	pr_info("%s micbias off\n", __func__);
	gpio_set_value_cansleep(MSM_GPIO_MICBIAS_EN, 0);
	gpio_set_value_cansleep(MSM_GPIO_SUBMICBIAS_EN, 0);
...
void msm_snddev_aux_dock_rx_route_config(void)
{
	...
	gpio_tlmm_config(GPIO_CFG
			(MSM_GPIO_AUDIO_SELECT, 0, GPIO_CFG_OUTPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_set_value_cansleep(MSM_GPIO_AUDIO_SELECT, 1);
...
void msm_snddev_aux_dock_rx_route_deconfig(void)
{
	...
	gpio_set_value_cansleep(MSM_GPIO_AUDIO_SELECT, 0);
...
void msm_snddev_poweramp_on_speaker_ext(void)
{
#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_ext(1);
#endif

	pr_info("%s: power on amplifier\n", __func__);
}

void msm_snddev_poweramp_off_speaker_ext(void)
{

#ifdef CONFIG_SENSORS_YDA173
	yda173_speaker_onoff_ext(0);
#endif
...
static struct taos_platform_data taos_plat_data = {
	...
	.wakeup = 1,
	.prx_thrsh_hi_param = 650,
	.prx_thrsh_lo_param = 480,
	.prx_thrsh_hi_calparam = 430,
	.prx_thrsh_lo_calparam = 330,
	.als_time_param = 0xED,
	.intr_filter_param = 0x33,
	.prx_pulse_cnt_param = 0x06,
	.ga = 75,
	.coef_a = 1000,
	.coef_b = 1850,
	.coef_c = 610,
...
static int __init optical_device_init(void)
{
	...
	opt_vreg_L13 = vreg_get(NULL, "ldo13");
	...
	opt_vreg_L11 = vreg_get(NULL, "ldo11");
...
static int __init sensor_gpio_init(void)
{
	pr_info("%s : %d\n", __func__, system_rev);

	if (system_rev > 3) {
		acc_mag_i2c_gpio_data.sda_pin = SENSORS_GPIO_SDA_REV_4;
		acc_mag_i2c_gpio_data.scl_pin = SENSORS_GPIO_SCL_REV_4;
	} else {
		acc_mag_i2c_gpio_data.sda_pin = SENSORS_GPIO_SDA_REV_3;
		acc_mag_i2c_gpio_data.scl_pin = SENSORS_GPIO_SCL_REV_3;
	}
	return 0;
}
...
static int __init magnetic_device_init(void)
{
	...
	mag_vreg_main = vreg_get(NULL, "ldo13");
	...
	mag_vreg_io = vreg_get(NULL, "ldo3");
...
#ifdef CONFIG_VP_A2220
/* ES305B GPIO */
#define MSM_AUD_A2220_WAKEUP		166
#define MSM_AUD_A2220_RESET		161
#define GPIO_A2220_I2C_SDA_REV03		80
#define GPIO_A2220_I2C_SCL_REV03		84
#define GPIO_A2220_I2C_SDA		1
#define GPIO_A2220_I2C_SCL		0
#define GPIO_A2220_UART_RX		51
#define GPIO_A2220_UART_TX		52
#define MSM_A2220_I2C_BUS_ID_REV03	22
#define MSM_A2220_I2C_BUS_ID	4
...
static int a2220_hw_init(void)
{
	...
	gpio_tlmm_config(GPIO_CFG
				(GPIO_A2220_UART_RX, 0, GPIO_CFG_INPUT,
				GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);

	rc = gpio_request(GPIO_A2220_UART_RX, "a2220_uart_rx");
	if (rc < 0)
		goto err_free_uart_rx_gpio;

	rc = gpio_direction_input(GPIO_A2220_UART_RX);
	if (rc < 0)
		goto err_alloc_data_failed;

	gpio_tlmm_config(GPIO_CFG
				(GPIO_A2220_UART_TX, 0, GPIO_CFG_INPUT,
				GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);

	rc = gpio_request(GPIO_A2220_UART_TX, "a2220_uart_tx");
	if (rc < 0)
		goto err_free_uart_tx_gpio;

	rc = gpio_direction_input(GPIO_A2220_UART_TX);
	if (rc < 0)
		goto err_alloc_data_failed;
...
err_free_uart_rx_gpio:
	gpio_free(GPIO_A2220_UART_RX);
err_free_uart_tx_gpio:
	gpio_free(GPIO_A2220_UART_TX);
...
static struct i2c_board_info a2220_device[] = {
	{
...
static struct i2c_gpio_platform_data  a2220_i2c_gpio_data_rev03 = {
	.sda_pin		= GPIO_A2220_I2C_SDA_REV03,
	.scl_pin		= GPIO_A2220_I2C_SCL_REV03,
	.udelay			= 1,
};
...
static struct platform_device a2220_i2c_gpio_device_rev03 = {
	.name			= "i2c-gpio",
	.id			= MSM_A2220_I2C_BUS_ID_REV03,
	.dev		= {
		.platform_data	= &a2220_i2c_gpio_data_rev03,
	},
...
*/
	pm8058_7x30_data.keypad_pdata = &ray_keypad_data;
...
static void fsa9485_usb_cdp_cb(bool attached)
{
	...
	tsp_charger_type_status = attached ? 1 : 0;
...
static struct i2c_board_info __initdata tma140_board_info[] = {
	{
...
/*yinbo.xie@ merge from ICON 20120829.begin.*/
...
#endif
/*yinbo.xie@ merge from ICON 20120829.end*/
/*yinbo.xie@ merge from ICON.20120822.begin.*/
...
/*yinbo.xie@ merge from ICON 20120822.end*/
...
*/
static int  update_panel_info(char *panel_name)
{
	int i;
	char *src = panel_name;
	char panel[2][5] = { "ICTL", "BOE" };
	/* yinbo.xie@ modify according to op manual 0910*/
	char polarity[2] = { 0, 0 };
	int panel_id[2] = { 1, 2 };
	static int lcd_id = -1;
	...
	if (!strncmp(src, "GET", 3)) {
		...
		if (lcd_id == -1) {
			printk(KERN_INFO "%s : Fail to get lcd panel name from bootloader\n",
			__func__);
			lcd_id = panel_id[1];
		} else {
			printk(KERN_INFO "%s : Suc to get panel name(%s) from bootloader\n",
			       __func__, panel[lcd_id - 1]);
		}
	}
...
int  check_recovery_mode(char *recovery_mode)
{
	char *flag = recovery_mode;
	static int recovery_flag;

	if (!strncmp(flag, "GET", 3)) {
		return recovery_flag;
	} else {
		recovery_flag = flag[0] - '0';
		printk(KERN_INFO "%s : recovery mode flag is %d\n",
		       __func__, recovery_flag);
	}
}

__setup("androidboot.boot_recovery=", check_recovery_mode);

/*yinbo.xie@ merge from ICON 20120822.end*/
#ifdef CONFIG_SAMSUNG_LCDC_AUTO_DETECT
...
#endif /*yinbo.xie@ merge from ICON.20120822*/
...
static struct msm_gpio lcd_panel_gpios[] = {
	...
	{GPIO_CFG(109, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
	 "lcdc_red7"},
	{GPIO_CFG(144, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
	 "nc"},
};
#ifndef CONFIG_SAMSUNG_LCDC_AUTO_DETECT
/* yinbo.xie@ merge from ICON 20120829.begin*/
...
/*yinob.xie@ merge from icon 20120829.end*/
#endif
/*yinbo.xie@ merge from icon. begin 20120827.*/
/* sleep */
...
/*yinbo.xie@ merge from icon. end 20120827.*/
static int lcdc_panel_power(int on)
{
	...
	/*yinbo.xie@ merge from icon.20120827*/
#ifndef CONFIG_SAMSUNG_LCDC_DISPLAY
	if (machine_is_msm7x30_fluid())
...
#ifdef CONFIG_VP_A2220
static struct platform_device *audience_device_rev03[] __initdata = {
	&a2220_i2c_gpio_device_rev03,
};
static struct platform_device *audience_device[] __initdata = {
...
/*	&mddi_toshiba_device, yinbo.xie@ merge from icon.20120827*/
/*	&lcdc_toshiba_panel_device, yinbo.xie@ merge from icon.20120827*/
#ifdef CONFIG_MSM_ROTATOR
	&msm_rotator_device,
#endif
/*	&lcdc_sharp_panel_device, yinbo.xie@ merge from icon.20120827*/
	&lcdc_s6d05a1_panel_device,/*yinbo.xie@ add for icon.20120827*/
...
static struct mmc_platform_data msm7x30_sdc4_data = {
	...
	.status_gpio = PM8058_GPIO_PM_TO_SYS(PMIC_GPIO_SD_DET - 1),
...
#endif
#ifdef CONFIG_MMC_MSM_SDC4_SUPPORT
		gpio_request(GPIO_TFLASH_EN , "tflash_en");
...
{
		pm8058_7x30_data.leds_pdata = &pm8058_ray_leds_data;
}
...
#ifdef CONFIG_VP_A2220
	if (system_rev > 03)
		platform_add_devices(audience_device,
			ARRAY_SIZE(audience_device));
	else
		platform_add_devices(audience_device_rev03,
			ARRAY_SIZE(audience_device_rev03));
#endif
...
#ifdef CONFIG_TOUCHSCREEN_TMA140
	i2c_register_board_info(5, tma140_board_info,
				ARRAY_SIZE(tma140_board_info));
#endif
...
#ifdef CONFIG_VP_A2220
			if (system_rev > 03) {
				i2c_register_board_info(4, a2220_device,
					ARRAY_SIZE(a2220_device));
				pr_info("A2220:register audience device id 4\n");
			} else {
				i2c_register_board_info(22, a2220_device,
					ARRAY_SIZE(a2220_device));
				pr_info("A2220:register audience device id 22\n");
			}
#endif
...
#ifdef CONFIG_ISX012
	i2c_register_board_info(6 /* QUP ID */, msm_camera_boardinfo,
				ARRAY_SIZE(msm_camera_boardinfo));
#endif
#ifdef CONFIG_SR130PC10
	i2c_register_board_info(20 /* QUP ID */, msm_front_camera_boardinfo,
				ARRAY_SIZE(msm_front_camera_boardinfo));
#endif
#if defined(CONFIG_SENSORS_YAS_ACCEL_DRIVER) || defined(CONFIG_SENSORS_YAS530C)
				 ...
				 struct meminfo *mi)
{
	for (; tags->hdr.size; tags = tag_next(tags)) {
		if (tags->hdr.tag == ATAG_MEM && tags->u.mem.start ==
				...
				ebi0_size = 0x10000000;
				break;
		}
	}
}

MACHINE_START(RAY, "SPH-M840")
	.atag_offset = 0x100,
